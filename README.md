...
661 tests across 8 files: pure function unit tests, mocked HTTP responses, CLI argument parsing, PMC integration, .fit file ingestion, ZWO linting, and prediction tracker tests. Expected runtime ~0.1s.
